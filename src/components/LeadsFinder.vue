    ...
    darkModeSwitch: {
      handler(newValue) {
        if (newValue) {
          ...
          document.querySelectorAll('.sticky_dark').forEach(e => e.classList.remove('sticky_dark'))
          document.querySelectorAll('.sticky_number__title_dark').forEach(e => e.classList.remove('sticky_number__title_dark'))
          document.querySelectorAll('.filter_header_dark').forEach(e => e.classList.remove('filter_header_dark'))
          document.querySelectorAll('.filter_header_divider_dark').forEach(e => e.classList.remove('filter_header_divider_dark'))
          document.querySelectorAll('.filter_container_dark').forEach(e => e.classList.remove('filter_container_dark'))
